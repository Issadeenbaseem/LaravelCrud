...
<body>
     ...
     <div style="width: 900px"    class="container max-w-full mx-auto pt-10">
            ...
            @csrf
            <div class="mb-4">
                <label class="font-bold text-gray-800" for="title">VerticalID: </label>
                ...
                name='verticalId' value="{{ $specializationVertical->verticalId }}" >
            </div>
            <div class="mb-4">
                <label class="font-bold text-gray-800" for="icon">SpecializationID: </label>
                <input class="h-10 bg-white border border-gray-300 rounded py-4 px-3 mr-4 w-full text-gray-600 text-sm focus:outline-none focus:border-gray-400 focus:ring-0"
                name='specializationId' value="{{ $specializationVertical->specializationId }}" >
            </div>
